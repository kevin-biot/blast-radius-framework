...
- **Current version:** v0.5.7 (2026-04-21) — strengthens SAPP I2 evidence by citing the role-based API surface (customer / consumer / regulator endpoints, QTSP-verifiable integrity check, three-level Merkle proof, 15-minute QTSP publication cycle). Backlog item 11 reframed from "publish runtime invariant-checking logic" to "extract SAPP API specification to public doc" (weeks, not quarter). §7 adds BR-4 floor analysis: Rule 2 prevents demotion below BR-4 for this consequence domain. Self-assessment v1.5. No framework definition changes.
