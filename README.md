...
- **Current version:** v0.5.3 (2026-04-21) — corrects the Invariant 5 rating in the Lane2 self-assessment (aARP + RTGF + Shared Ontology provide architectural jurisdictional enforcement; OBO is a convenience interop option, not core I5). Self-assessment updated to v1.1 with explicit correction note. No framework definition changes.
...
- **Tags:** `v0.5` (initial public release), `v0.5.1` (notation extracted, worked examples added, observability strengthened), `v0.5.2` (report template, Lane2 self-assessment, worked template application), `v0.5.3` (self-assessment I5 correction — aARP + RTGF + Shared Ontology as core I5 mechanism; OBO as convenience interop). External citations should use explicit version tags — e.g. `framework.md v0.5.1 §5.1` — rather than tracking `main`.
