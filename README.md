...
- **Current version:** v0.5.8 (2026-04-21) — adds [`authoring-notes.md`](./authoring-notes.md) documenting the human-domain-holder + AI-epistemic-partner force-function method under which this repo and the Lane2 self-assessment artefacts were produced. Transparent provenance of method. Prescription for deployers producing their own ratings. Counter to A14 and A7 anti-patterns applied to assessment authoring. No framework definition changes.
